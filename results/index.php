...
function drawImage($speedtest)
{
    ...
    $BACKGROUND_COLOR = imagecolorallocate($im, 32, 32, 32);
    ...
    $TEXT_COLOR_DL_METER = imagecolorallocate($im, 0, 139, 255);
    $TEXT_COLOR_UL_METER = imagecolorallocate($im, 255, 245, 0);
    $TEXT_COLOR_MEASURE = imagecolorallocate($im, 255, 255, 255);
    $TEXT_COLOR_ISP = imagecolorallocate($im, 255, 255, 255);
    $SEPARATOR_COLOR = imagecolorallocate($im, 128, 128, 128);
    $TEXT_COLOR_TIMESTAMP = imagecolorallocate($im, 128, 128, 128);
    $TEXT_COLOR_WATERMARK = imagecolorallocate($im, 124, 178, 66);
